...
<header class="bg-white" x-data="{ open: false }">
	...
	>
		...
		<div class="hidden lg:flex lg:gap-x-12">
			...
			<!-- Solutions dropdown -->
			<div class="relative" x-data="{ open: false }">
				<button type="button" class="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false" @click="open = ! open">
					<span>Solutions</span>
						...
						<div class="grid grid-cols-1 gap-x-6 gap-y-1 p-4 lg:grid-cols-2">
							...
							<div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
								...
								<div>
									...
									<p class="mt-1 text-gray-600">Edit, manage and create newly informed decisions</p>
								</div>
							</div>
						</div>
				...
				<div class="-my-6 divide-y divide-gray-500/10">
					<div class="space-y-2 py-6">
						...
						<div class="-mx-3" x-data="{ open: false }">
							...
							<!-- 'Solutions' sub-menu, show/hide based on menu state. -->
							<div class="mt-2 space-y-2" id="disclosure-1" x-show="open">
								<a
									href="#"
									class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50"
